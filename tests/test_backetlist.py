...
class TestBucketList(unittest.TestCase):
    """"""
    def setUp(self):
        self.mybucketlist = BucketList('Before 50', 'Activities to accomplish before 50')
    ...
    def test_add_activity_success(self):
        ...
        self.assertIn(self.myactivity, self.mybucketlist.activities, msg="Added activity should be present in list activities of the bucketlist object")

    def test_add_activity_string_input(self):
        """add_activity should raise type error with non activity objects"""
        self.assertRaises(TypeError, self.mybucketlist.add_activity, 'activity name', msg="Input should activity object")
    ...
    def test_remove_activity_non_string(self):
        """"""
        self.assertRaises(TypeError, self.mybucketlist.remove_activity, 57, msg="Activity name should be a string")
